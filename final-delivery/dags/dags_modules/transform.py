import pandas as pd
# Si se desea correr una versión con menos registros a los fines evaluativos ejecutar el código
# Version light. La versión que trae toda la data real es Versión full.
